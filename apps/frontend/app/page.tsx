...
import { Activity, Bell, Shield, Clock, Server, ArrowRight, Check, Moon, Sun } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex items-center space-x-4">
              <button className="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 transition flex items-center">
                Start Monitoring Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </button>
              <button className="px-6 py-3 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                View Demo
              </button>
            </div>
          </div>
...
function PricingCard({ title, price, features, featured = false }) {
  return (
    <div className={`p-8 rounded-lg ${
      featured 
        ? 'bg-indigo-600 text-white dark:bg-indigo-500 ring-4 ring-indigo-300 dark:ring-indigo-400/30' 
